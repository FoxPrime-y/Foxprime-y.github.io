<template><div><h1 id="leetcode02-05" tabindex="-1"><a class="header-anchor" href="#leetcode02-05"><span>LeetCode02.05</span></a></h1>
<div class="language-面试题02.05 line-numbers-mode" data-highlighter="prismjs" data-ext="面试题02.05" data-title="面试题02.05"><pre v-pre><code><span class="line">给定两个用链表表示的整数，每个节点包含一个数位。</span>
<span class="line">这些数位是反向存放的，也就是个位排在链表首部。</span>
<span class="line">编写函数对这两个整数求和，并用链表形式返回结果。</span>
<span class="line"></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line"> public ListNode addTwoNumbers(ListNode l1, ListNode l2) {</span>
