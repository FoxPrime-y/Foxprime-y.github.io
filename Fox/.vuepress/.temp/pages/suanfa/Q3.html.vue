<template><div><h1 id="力扣周赛441场q3" tabindex="-1"><a class="header-anchor" href="#力扣周赛441场q3"><span>力扣周赛441场Q3</span></a></h1>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  public int all(int[] fruits, int[] baskets) {</span>
