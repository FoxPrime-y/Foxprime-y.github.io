<template><div><h1 id="leetcode128" tabindex="-1"><a class="header-anchor" href="#leetcode128"><span>LeetCode128</span></a></h1>
<div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">这道题的核心思路是利用哈希集合（HashSet）来实现O(n)的时间复杂度算法，以找出给定数组中数字连续的最长序列的长度。</span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre v-pre><code><span class="line">  public int longestConsecutive(int[] nums) {</span>
