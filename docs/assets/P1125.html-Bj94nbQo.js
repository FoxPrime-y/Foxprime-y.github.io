import{_ as s,c as e,a,o as i}from"./app-FYnelbtM.js";const l={};function d(t,n){return i(),e("div",null,n[0]||(n[0]=[a(`<h1 id="p1025" tabindex="-1"><a class="header-anchor" href="#p1025"><span>P1025</span></a></h1><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text" data-title="text"><pre><code><span class="line">我们需要遍历之前统计的字母出现次数数组，找出其中的最大值和最小值。需要注意的是，对于那些没有出现的字母（即统计数组中值为0的字母），我们不应该将它们计入 minn 的计算中。</span>
...
<span class="line">    }</span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3)]))}const p=s(l,[["render",d],["__file","P1125.html.vue"]]),r=JSON.parse('{"path":"/suanfa/P1125.html","title":"P1025","lang":"en-US","frontmatter":{},"headers":[],"git":{},"filePathRelative":"suanfa/P1125.md"}');export{p as comp,r as data};
